...
describe UserExpense do
  ...
  before(:each) do
    ...
    @test_user_expense1 = test_user1.user_expenses.create!(expense_id: test_expense1.id, portion: 500.00, paid: 20)
    @test_user_expense1 = test_user2.user_expenses.create!(expense_id: test_expense1.id, portion: 400.00, paid: 400) 
  end

  it { should belong_to(:user) }
  it { should belong_to(:expense) }
  it { should have_one(:payer) }
